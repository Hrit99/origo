    ...
    return MouseRegion(
      ...
      child: Container(
        child: Row(
          children: [
            Container(
              width: dimensions.getWidth(604),
              height: dimensions.getHeight(614),
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                            border:
                                Border.all(color: Color.fromRGBO(11, 10, 10, 1))),
                        height: dimensions.getHeight(14),
                        width: dimensions.getWidth(14),
                      ),
                    ],
                  ...
                  Image.asset(
                    widget.imgstr,
                    width: dimensions.getWidth(556),
                    height: dimensions.getHeight(566),
                    fit: BoxFit.cover,
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            Container(
              ...
              padding: EdgeInsets.all(dimensions.getWidth(48)),
              child: Column(
                ...
                children: [
                  ...
                  ConstrainedBox(
                    constraints: BoxConstraints(
                        maxWidth:
                            dimensions.getWidth(508)), // Adjust width as needed
                    child: Text(
                      widget.title,
                      style: TextStyle(
                        fontFamily: "Supply",
                        fontSize: dimensions.getHeight(48),
                        fontWeight: FontWeight.w700,
                        color: Color.fromRGBO(11, 10, 10, 1),
                      ),
                      textAlign: TextAlign.left,
                  ...
                  SizedBox(height: dimensions.getHeight(58),),
                  Borderbutton(
                      height: dimensions.getHeight(58),
                      width: dimensions.getWidth(265),
                      action: () => {},
